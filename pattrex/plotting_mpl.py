...
def plot2d(X, show=True, set_aspect_equal=True, x_lim=None, y_lim=None, show_axes_through_origin=False, plotlabel=None, title=None):
    ...
    axs.plot(X[0,:], X[1, :], 'ro', label=plotlabel)
